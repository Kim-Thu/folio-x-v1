...
export const sidebarAsideMobilePositionClasses: Record<LSidebarPosition, string> = {
	start: "order-1",
	end: "order-2",
};
...
export const sidebarContentMobilePositionClasses: Record<LSidebarPosition, string> = {
	start: "order-2",
	end: "order-1",
};
