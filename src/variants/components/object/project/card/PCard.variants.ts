...
export const pCardSliderItemClasses: Record<PCardColumns, string> = {
	...
	3: "min-w-0 grow-0 shrink-0 basis-5/6 sm:basis-1/2 lg:basis-1/3",
	4: "min-w-0 grow-0 shrink-0 basis-5/6 sm:basis-1/2 lg:basis-1/4",
	5: "min-w-0 grow-0 shrink-0 basis-5/6 sm:basis-1/2 lg:basis-1/5",
};
