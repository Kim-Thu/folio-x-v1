...
const variantClasses: Record<ImageVariant, string> = {
	...
	interactiveCover:
		"size-full object-cover transition-transform duration-reveal group-hover:scale-media group-hover/card:scale-media",
	interactiveFillCover:
		"absolute inset-0 size-full object-cover transition-transform duration-reveal group-hover:scale-media",
