...
export function getHeaderClasses(solid: boolean): string {
  return twJoin(
    'fixed inset-x-0 top-0 z-40 border-b-hairline border-transparent transition-all duration-interaction will-change-transform data-[scroll-state=hidden]:-translate-y-full',
